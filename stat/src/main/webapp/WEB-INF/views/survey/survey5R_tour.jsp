	...
	<div class="uppermain" style="width: 100%" >
		<div class="row">
			...
			<div class="col-md-10" align="center">
				<h3 style="color: white; font-weight: bold;">당신이 여행하고 싶은 나라는 "${tour_nation }"이군요</h3>
				<hr>
				<h4>설문조사 응답자들이 선호하는 여행지는 다음과 같습니다 </h4>
				<img alt="" src="${path }/fileSave/TourChart.png" width="400px">
				<br>
				<hr>
				<h5>※ 다음은 2015년도 해외여행 희망나라 통계자료입니다</h5>
				<img alt="" src="${path }/images/tour.jpg" width="900px">
				<div>&nbsp;</div>
